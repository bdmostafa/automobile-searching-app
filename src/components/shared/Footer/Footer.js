import { faCodepen, faFacebookF, faGithub, faLinkedin, faYoutube } from '@fortawesome/free-brands-svg-icons';
                ...
                <Container>
                    ...
                    <Row>
                        <Col className="text-left p-2 text-decoration-none">
                            <p>&copy;Copyright {new Date().getFullYear()}. Automobile Searching App. Developed by <a href="https://mdmostafa.com">Mostafa</a></p>
                        </Col>
